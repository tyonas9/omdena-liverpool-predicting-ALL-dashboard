...
with col2:
    ...
    st.header('Salman')
    st.subheader('Chapter Lead')
    st.write("My machine learning journey began in 2008, implementing numerical methods and conducting research on predictive modeling for time series data. I developed projects predicting rainfall and heart attacks, supervised projects predicting ECG and EMG results, and designed mathematical models for neurons and Alzheimer's behavior.")
...
with col3:
    ...
    st.write(" I'm a data geek with a passion for solving complex problems and a track record of delivering results. With experience working on collaborative projects, I've developed a strong team player mindset and a keen eye for detail. I believe in continuous learning and have been working on building my skillset for the past 3 years. Currently focusing on  NLP and Computer Vision. ")
    st.write(
        fa_li,
...
with col4:
    ...
    st.write("I'm a data professional with experience in physics, seismic data analysis, and flight planning. I transitioned to data science and machine learning, leveraging mathematical theory to uncover hidden value in data. I'm passionate about telling data stories through engaging and intuitive visualizations to provide insights that positively impact businesses.")
    st.write(
...
with col1:
    ...
    st.header('Wallace')
    st.subheader('Team Member')
    st.write("I consult and conduct scientific research in data-driven methods for business, engineering simulation, and optimization. I have experience as a consultant in data science and business intelligence projects, and volunteered as a data scientist in open-source projects. I hold a Ph.D. in ensembles of supervised methods for engineering optimization, have automotive industry experience, and have taught at universities.")
    st.write(
...
with col2:
    ...
    st.header('Neville')
    st.subheader('Team Member')
    st.write("Recently completed a master’s degree in Artificial Intelligence from Loughborough University, UK. My main skills include Python, Machine Learning, big data technologies and frameworks. I am a current Golden Visa holder within the UAE. My aim is to work in the field of data analytics/science, machine learning or statistics while learning new skills which will benefit me and my employer.")
    st.write(
        fa_li,
...
with col3:
    ...
    st.header('Soumya')
    st.subheader('Team Member')
    st.write("With a master's degree in physics, I focus on studying 2D materials like graphene and their heterostructures using simulations and theoretical models. I have experience in neutrino detector simulations, teaching physics and mathematics, and expertise in Python, Scikit-Learn, and Tensorflow/Keras. My goal is to use data analytics and machine learning to solve real-world problems and make a positive impact on society.")
    st.write(
        fa_li,
...
with col4:
    ...
    st.header('Varun')
    st.subheader('Team Member')
    st.write("A Data enthusiast, helping startups in making data-driven decisions and achieving their goals. Experience in ETL processing, data automation, financial and BI analysis, and reporting. Knowledge of database management, machine learning algorithms, and cloud architecture.")
    st.write(
        fa_li,
